            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-50 text-sm">392002 Ratings</p>
                  <p className="ml-3 text-sm font-medium text-indigo-700 hover:text-indigo-400">
                    3902 Reviews
                  </p>
                </div>
              </div>
                ...
                <div className="border p-5">
                    <Grid container spacing={7}>
                        ...
                        <Grid item xs={5}>
                            ...
                            <div className="flex items-center space-x-3">
                                <Rating value={4.3} precision={.1} readOnly/>
                                <p className="opacity-60">392002 Ratings</p>
                            </div>
                            <Box className="mt-5 space-y-3">
                                ...
                                <Grid container alignItems="center" gap={2}>
                                    ...
                                    <Grid item xs={7}>
                                        <LinearProgress sx={{bgcolor:"#d0d0d0",borderRadius:4,height:7}} variant="determinate" value={15} color="info"/>
                                    </Grid>
                                </Grid>
                                <Grid container alignItems="center" gap={2}>
                                    <Grid item xs={2}>
